...
export const Bio = {
  ...
  description:
    "I am a versatile web developer dedicated to transforming ideas into polished, user-centric websites.  With a knack for problem-solving, I am committed to delivering high-quality, intuitive web experiences that resonate with users and exceed client expectations.",
...
export const experiences = [
  {
    ...
    desc: "Designed and developed the official website for PrepBook",
    skills: [
      "CSS",
      "Bootstrap",
      "JavaScript",
  ...
  },
  {
    ...
    desc: "Developed multiple practical projects utilizing Flask and Bootstrap, including applications for inventory management, e-commerce platforms, and more.",
    skills: [
      "Flask",
      "Firebase",
      "Sqlite",
...
export const education = [
  {
    ...
    grade: "8.21 CGPA",
    desc: "I am currently pursuing a Master's degree in Computer Applications at Akurdi. I have completed 2 semesters and have a CGPA of 8.21.",
    degree: "MCA",
  },
  {
    id: 1,
    ...
    grade: "9.6 cgpa",
    desc: "I pursued my bachelor's degree at D.G. Ruparel College, Mumbai.",
  ...
  },
  {
    ...
    grade: "64.15%",
    desc: "I completed my class 12 education at D.G. Ruparel College of Arts, Science and Commerce, Mumbai",
    degree: "HSC(XII)",
  },
  {
    id: 3,
    ...
    grade: "89.40%",
    desc: "I completed my class 12 education at Cardinal Gracias High School, Mumbai",
    degree: "SSC(X)",
  }
];
